                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('pengeluaran/store') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control <?= $validation?->hasError('tanggal') ? 'is-invalid' : '' ?>" id="tanggal" name="tanggal" value="<?= old('tanggal', date('Y-m-d')) ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= $validation?->hasError('kategori_pengeluaran') ? 'is-invalid' : '' ?>" id="kategori_pengeluaran" name="kategori_pengeluaran" value="<?= old('kategori_pengeluaran') ?>" placeholder="Contoh: Listrik, Air, Gaji, dll." required>
                             ...
                             <div class="mb-3">
                                ...
                                <input type="number" step="0.01" class="form-control <?= $validation?->hasError('jumlah') ? 'is-invalid' : '' ?>" id="jumlah" name="jumlah" value="<?= old('jumlah') ?>" required>
