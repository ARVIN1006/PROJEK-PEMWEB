                    ...
                    <div class="card-body">
                        ...
                        <form action="<?= base_url('pelanggan/store') ?>" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control <?= $validation?->hasError('nama_pelanggan') ? 'is-invalid' : '' ?>" id="nama_pelanggan" name="nama_pelanggan" value="<?= old('nama_pelanggan') ?>" required>
